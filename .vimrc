...
" Pathogen support
let pathogenPath = "bundle/vim-pathogen/autoload/pathogen.vim"
if (filereadable(g:vimPath . pathogenPath))
    runtime bundle/vim-pathogen/autoload/pathogen.vim
    call pathogen#incubate()
    call pathogen#helptags()

    " File-skeleton
    let g:skeletonAuthor = 'wei xiuyuan'
    let g:skeletonEmail = 'weixiuyuan@meituan.com'
